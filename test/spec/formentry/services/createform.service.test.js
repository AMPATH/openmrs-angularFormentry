      ...
      */
      if (typeof String.prototype.startsWith !== 'function') {
        ...
        describe('createForm Method unit Tests', function () {
            ...
            var model = {};
            beforeEach(function () {
                functionStub = sinon.spy(createFormService, 'createForm');
                mockSchema = mockData.getMockSchema();
                mockForm = createFormService.createForm(mockSchema, model).formlyForm;
            });
            ...
            it('should be called with parameters', function () {
                ...
                expect(functionStub.firstCall.calledWithExactly(mockSchema, model)).to.be.true;
