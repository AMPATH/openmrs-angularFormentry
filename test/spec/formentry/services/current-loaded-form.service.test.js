  ...
  describe('Current Loaded Form Service Navigation Unit Tests', function () {
    ...
    beforeEach(function () {
      formlyModel = {
        ...
        section_2: {
          obs3_a89ff9a6n1350n11dfna1f1n0026b9348838: {
            concept: "1232",
            value: '1234565',
            schemaQuestion: {
              type: "obs",
    ...
    it('should getAnswerByQuestionKey for questions without value member', function () {
      //case existing key
      var answer = service.getAnswerByQuestionKey(formlyModel, 'obs3_a8a003a6n1350n11dfna1f1n0026b9348838');
      expect(Array.isArray(answer)).to.equal(true);
    ...
    it('should clear non-group question when clearQuestionValueByKey', function () {
      ...
      console.log('value after clearing', newValue);
    ...
    it('should clear group question when clearQuestionValueByKey', function () {
      ...
      console.log('is array: after clearing',newValue);
